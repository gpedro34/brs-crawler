...
CREATE TABLE IF NOT EXISTS scans (
  ...
  CONSTRAINT scans_platform_id_fk FOREIGN KEY (platform_id) REFERENCES scan_platforms (id) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT scans_version_id_fk FOREIGN KEY (version_id) REFERENCES scan_versions (id) ON DELETE RESTRICT ON UPDATE RESTRICT
)
AUTO_INCREMENT=1
ENGINE=InnoDB
DEFAULT CHARSET=utf8mb4
